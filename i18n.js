...
const I18N = (() => {
  ...
  const EN = {
    ...
    /* The three title ladders — achievements seen, marks collected, species mastered. */
    "เพิ่งมาถึงมิธวูด": "Newly arrived in Mythwood",
    "ปลดความสำเร็จ 3 รายการ": "3 achievements unlocked",
    "ผู้เริ่มสะสมรอยล่า": "Marked Hand",
    "เก็บรอยล่า 10 ดวง": "10 slayer marks earned",
    "ปลดความสำเร็จ 7 รายการ": "7 achievements unlocked",
    "ปลดความสำเร็จ 12 รายการ": "12 achievements unlocked",
    "นักล่าประจำหุบเขา": "Hunter of the Valley",
    "เก็บรอยล่า 40 ดวง": "40 slayer marks earned",
    "ผู้ปราบสายพันธุ์แรก": "First Species Broken",
    "ล่าสายพันธุ์หนึ่งจนถึงชั้นโกลาหล": "One species hunted to Chaos",
    "ผู้เก็บครบทุกเรื่องเล่า": "Keeper of Every Tale",
    "ปลดความสำเร็จครบทั้ง 18 รายการ": "All 18 achievements unlocked",
    "ผู้ไล่ล่าไม่เลือกหน้า": "Relentless",
    "เก็บรอยล่า 90 ดวง": "90 slayer marks earned",
    "ล่า 3 สายพันธุ์จนถึงชั้นโกลาหล": "Three species hunted to Chaos",
    "ล่า 8 สายพันธุ์จนถึงชั้นโกลาหล": "Eight species hunted to Chaos",
    "เงาที่ทุกป่าจดจำ": "The Shadow Every Wood Remembers",
    "เก็บรอยล่า 150 ดวง": "150 slayer marks earned",
    "ฝันร้ายของทั้งหุบเขา": "Nightmare of the Whole Valley",
    ...
    /* The fifty coins are invented brand names, so the English is the name itself rather than a
       translation of the Thai spelling of it. */
    "มูนบิต": "Moonbit",
    "สตาร์คอยน์": "Starcoin",
    "เอมเบอร์เอ็กซ์": "Emberx",
    "กลาเซีย": "Glacia",
    "เวอร์แดนท์": "Verdant",
    "ออบซิเดีย": "Obsidia",
    "ออเรียส": "Aureus",
    ...
    "ควอตเซีย": "Quartzia",
    "ดริฟต์วูด": "Driftwood",
    "ฮอลโลว์สกาย": "Hollowsky",
    "ซอลต์เวน": "Saltvein",
    "บริมสโตน": "Brimstone",
    "ฟรอสต์ไบต์": "Frostbite",
    "กิลเดนแรต": "Gildenrat",
    "ไทด์วอล์คเกอร์": "Tidewalker",
    "แอชเชนมาร์ก": "Ashenmark",
    "คอปเปอร์แฟง": "Copperfang",
    "เซเบิลคอยน์": "Sablecoin",
    "วิสป์คอยน์": "Wispcoin",
    "รูนสโตน": "Runestone",
    "ฮัลไซออน": "Halcyon",
    "วอยด์มาร์ก": "Voidmark",
    "ซันเดอไรต์": "Sunderite",
    "มอสส์แบงก์": "Mossbank",
    "เฮิร์ธเอ็กซ์": "Hearthx",
    "เนตเทิลคอยน์": "Nettlecoin",
    "พริสมิก": "Prismic",
    "บ็อกไอรอน": "Bogiron",
    "สกายชาร์ด": "Skyshard",
    "ดัสก์ไลต์": "Dusklight",
    "เฟอร์ร็อกซ์": "Ferrox",
    "เวิร์มโกลด์": "Wyrmgold",
    "ซิลต์": "Silt",
    "เคลป์คอยน์": "Kelpcoin",
    "กราเวลมาร์ก": "Gravelmark",
    "เอเธอร์เอ็กซ์": "Aetherx",
    "ทิสเซิล": "Thistle",
    "บีคอน": "Beacon",
    "สโตนเวก": "Stonewake",
    "เอมเบอร์เลซ": "Emberlace",
    "ไนต์เฟน": "Nightfen",
    "กลูมคอยน์": "Gloamcoin",
    "เรเซอร์ฟิน": "Razorfin",
    "เทอร์ราคอยน์": "Terracoin",
    "ปกติ ": "usual ", "ทุน ": "cost ", "มูลค่าต่อหน่วย": "per unit",
    "เตาผิงหินอ่อน": "Marble hearth", "ห้องอ่านหนังสือ": "Reading room",
    "ห้องอาบน้ำแร่": "Mineral bath", "กรงนกเรือนกระจก": "Glasshouse aviary",
    "คริปโต — ไม่มีปันผล กำไรอยู่ที่ส่วนต่างราคาอย่างเดียว":
      "Crypto — no dividends; the only gain is the difference in price",
    "เหรียญที่ถือ": "Coins held", "มูลค่าตอนนี้": "Worth now",
    "กำไร/ขาดทุนถ้าขายตอนนี้": "Gain/loss if sold now",
    "แพงกว่าปกติมาก": "far above its usual", "แพงกว่าปกติ": "above its usual",
    "ถูกกว่าปกติมาก": "far below its usual", "ถูกกว่าปกติ": "below its usual",
    "ราคาปกติ": "around its usual", "ปกติ": "usual",
    "เหวี่ยงแรงมาก": "swings violently", "เหวี่ยงแรง": "swings hard", "ค่อยๆ ขยับ": "drifts slowly",
    "ถือ": "holding", "ทุนเฉลี่ย": "avg cost",
    "ซื้อ": "Buy", "ขาย": "Sell", "ซื้อเท่าที่ไหว": "Buy max",
    "ขายครึ่ง": "Sell half", "ขายหมด": "Sell all",
    "กำไร": "gain", "ขาดทุน": "loss",
    "ค่าเช่าปีที่": "Rent, year", "ปีที่": "Year",
    "ค่าเช่าอสังหา": "Property rent", "กำไรลงทุน": "Investment gains",
    "ภาษี": "tax", "ยังไม่ถึงเกณฑ์": "exempt below",
    "ภาษีเงินได้ค่าเช่า": "Rental income tax",
    "ค่าเช่าที่เก็บได้จริงตลอดปีนี้": "Rent actually collected this year",
    "ภาษีเงินได้การลงทุน": "Investment income tax",
    "ปันผล กำไรจากการขายหุ้นและคริปโต และดอกเบี้ยธนาคาร ตลอดปีนี้":
      "Dividends, gains from selling shares and crypto, and bank interest, across this year",
    ...
    "ไม่ได้ทิ้งงานสายอาชีพไว้ — รายได้ที่เข้าเองยังเดินตามปกติ":
      "No job was left running — income that arrives on its own still came in",
    "รายได้ที่เข้าเอง": "Income that arrived on its own",
    "ได้ทองรวม": "Gold in total", "ระหว่างออฟไลน์": "While you were away",
    "ระหว่างที่ไม่อยู่": "While you were away", "หายไป": "Away for",
    "คิดให้สูงสุด": "counted up to", "ชั่วโมง": "hours",
    "ไอเทม": "items", "เงินรวม": "gold in total", "ขึ้น": "up", "เลเวล": "levels",
    "คิดจาก": "from", "ที่": "at", "ของอัตราปกติ": "of the normal rate",
    "วัตถุดิบหมดก่อน งานเลยหยุดกลางทาง": "Ran out of materials, so the job stopped part-way",
    "ปฏิทินไม่เดิน ความชำนาญไม่ขึ้น แปลงปลูกไม่โต และการล่ามอนสเตอร์ไม่เดินต่อ":
      "The calendar does not move, mastery does not rise, crops do not grow, and hunting does not continue",
    "วันในเกม": "game-days", "งานที่ทำค้างไว้": "the job you left running",
    "ค่าเช่า": "rent", "ปันผล": "dividends", "ร้านค้า": "shops",
